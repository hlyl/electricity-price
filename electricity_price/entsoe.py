...
class EntsoeClient:
    ...
    def day_ahead_prices(self, domain, start_time, end_time, vat=0.0): 
        ...
        endpoint = "/api?securityToken={0}&documentType={1}&in_Domain={2}&out_Domain={2}&periodStart={3}&periodEnd={4}".format(self.token, document_type, domain, period_start, period_end)
